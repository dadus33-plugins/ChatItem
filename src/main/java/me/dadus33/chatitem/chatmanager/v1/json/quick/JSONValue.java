...
public class JSONValue {
	 ...
	 * 
	 * @see me.dadus33.chatitem.chatmanager.v1.json.quick.parser.JSONParser#parse(Reader)
	 ...
	 * 
	 * @see me.dadus33.chatitem.chatmanager.v1.json.quick.JSONObject#writeJSONString(Map,
	 *      Writer)
	 * @see me.dadus33.chatitem.chatmanager.v1.json.quick.JSONArray#writeJSONString(List,
	 *      Writer)
	 * 
	 * @param value
	 * @param writer
	 ...
	 * 
	 * @see me.dadus33.chatitem.chatmanager.v1.json.quick.JSONObject#toJSONString(Map)
	 * @see me.dadus33.chatitem.chatmanager.v1.json.quick.JSONArray#toJSONString(List)
	 * 
	 * @param value
